...
public class SextaFeira implements Dia {

	@Override
	public String obterMensagem() {
		return "No sexto dia, Deus criou os animais terrestres. Todo tipo de animal que vive na terra e não voa foi criado nesse dia, cada um com capacidade para reproduzir.\r\n" + 
				"\r\n" + 
